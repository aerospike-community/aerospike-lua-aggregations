...
public class Main extends JPanel {
	...
	public static void main(String[] args) {
		...
		try {
			...
			options.addOption("i", "files", true, "list of files");
	...
	private static Parameters parseParameters(CommandLine cl) throws Exception {
		...
		String fileName = cl.getOptionValue("i", "");
		...
		return new Parameters(tlsPolicy, host, port, user, password, authMode, namespace, set, fileName);
	}
